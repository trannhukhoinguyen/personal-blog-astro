...
In my case i know about astro earlier, it's popular for content-driven sites. Started checking few open-source repos using Astro, clonned there blog website starter template. Started replicating my NextJS app on Astro
